...
other_points_P = [(1/6,1/2), (1/6,0), (0,0), (0,1)]
P = p_arc + other_points_P

# Q
theta_Q = math.degrees(math.atan(math.sqrt(5)/2))
q_arc = arc_points(1/2, -theta_Q, 270, center=[1/2,1/2])
other_points_Q = [(1,0), (1,1/6)]
Q = q_arc + other_points_Q

# R
r_arc = arc_points(1/4, 90, -90, center=[3/4, 3/4])
other_points_R = [(3/4, 1/2), (1, 0), (5/6, 0), (1/2, 1/2), (1/6, 1/2), (1/6, 0), (0, 0), (0, 1)]
R = r_arc + other_points_R

# S
outer_arc_S_top = arc_points(1/4, 0, 180, center=[1/2, 3/4])
outer_arc_S_bottom = arc_points(1/4, 180, 360, center=[1/2, 1/4])
inner_arc_S_top = arc_points(1/12, 180, 0, center=[1/2, 3/4])
inner_arc_S_bottom = arc_points(1/12, 360, 180, center=[1/2, 1/4])
S = outer_arc_S_top + outer_arc_S_bottom + inner_arc_S_bottom + inner_arc_S_top

# T
T = [(0,5/6), (0,1), (1,1), (1,5/6), (7/12,5/6), (7/12,0), (5/12,0), (5/12,5/6)]

# U
outer_arc_U = arc_points(1/2, 180, 360, center=[1/2, 1/2])
other_points_U = [(1,1), (5/6,1), (5/6,1/2), (1/6,1/2), (1/6,1), (0,1)]
inner_arc_U = arc_points(1/3, 360, 180, center=[1/2, 1/2])
U = outer_arc_U + other_points_U + inner_arc_U

# V
V = [(0,1), (1/6,1), (1/2,0), (5/6,1), (1,1), (1/2,0-1/6)]

# W
W = [(0,1), (1/6,1), (1/3,0), (1/2,1/2), (2/3,0), (5/6,1), (1,1), (2/3,0-1/6), (1/2,1/2-1/6), (1/3,0-1/6)]

# X
X = [(0,0), (1/6,0), (1/2,1/2-math.sqrt(2)/12), (5/6,0), (1,0), (1/2,1/2), (1,1), (5/6,1), (1/2,1/2+math.sqrt(2)/12), (1/6,1), (0,1), (1/2,1/2)]

# Y
Y = [(0,1), (1/6,1), (1/2,1/2), (5/6,1), (1,1), (1/2,1/3), (1/2,0), (1/3,0), (1/3,1/3), (1/2,1/2)]

# Z
Z = [(0,5/6), (0,1), (1,1), (1,5/6), (1/6,1/6), (1,1/6), (1,0), (0,0), (0,1/6), (5/6,5/6)]
...
# You can use this to access the points for any letter
# Example: points_for_A = alphabet['A']