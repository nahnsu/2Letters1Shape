// Generated by SolidPython 1.1.3 on 2025-02-25 01:33:38
$fn=50;
...
intersection() {
	...
	rotate(a = 90, v = [0, 1, 0]) {
		translate(v = [-5.0000000000, -5.0000000000, -5.0000000000]) {
			linear_extrude(height = 10) {
				polygon(points = [[0, 0], [1.6666666667, 0], [2.3570226040, 1.6666666667], [5.2859547921, 5.2859547921], [5.2859547921, 0], [10, 0], [5.0000000000, 5.0000000000], [10, 10], [5.2859547921, 10], [1.6666666667, 7.0710678119], [1.6666666667, 10], [0, 10]]);
			}
		}
	}
}
