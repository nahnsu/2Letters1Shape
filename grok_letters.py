...
# O
O = arc_points(1/2, 0, 360, center=[1/2,1/2]) + arc_points(1/3, 360, 0, center=[1/2,1/2])[::-1]

# P
P = [(0,0), (0,1), (1/6,1)] + arc_points(1/4, 90, 0, center=[3/4,3/4]) + [(1,3/4), (1/6,1/2), (1/6,0)]

# Q
Q = arc_points(1/2, 0, 360, center=[1/2,1/2]) + arc_points(1/3, 360, 0, center=[1/2,1/2])[::-1] + [(2/3,0), (1,0), (1,-0.1), (2/3,-0.1)]

# R
R = [(0,0), (0,1), (1/6,1)] + arc_points(1/4, 90, 0, center=[3/4,3/4]) + [(1,3/4), (1/6,1/2), (1,0), (1,1/6), (1/6,0)]

# S
S = arc_points(1/4, 90, -90, center=[1/4,3/4]) + arc_points(1/4, 90, -90, center=[3/4,1/4]) + [(0,1/2), (1,1/2)]

# T
T = [(0,1), (1,1), (1,5/6), (7/12,5/6), (7/12,0), (5/12,0), (5/12,5/6), (0,5/6)]

# U
U = [(0,1), (0,0)] + arc_points(1/3, 180, 0, center=[1/2,1/3]) + [(1,0), (1,1), (5/6,1), (5/6,1/6), (1/6,1/6), (1/6,1)]

# V
V = [(0,1), (1/2,0), (1,1), (5/6,1), (1/2,1/3), (1/6,1)]

# W
W = [(0,1), (1/4,0), (1/2,1), (3/4,0), (1,1), (5/6,1), (3/4,1/3), (1/2,0), (1/4,1/3), (1/6,1)]

# X
X = [(0,0), (1/6,0), (1/2,1/2), (1/6,1), (0,1), (0,5/6), (1/3,1/2), (0,1/6)] + [(1,0), (5/6,0), (1/2,1/2), (5/6,1), (1,1), (1,5/6), (2/3,1/2), (1,1/6)]

# Y
Y = [(0,1), (1/2,1/2), (1,1), (5/6,1), (1/2,1/3), (1/6,1), (1/2,1/2), (1/2,0), (1/3,0), (1/3,1/3), (2/3,1/3), (2/3,0)]
