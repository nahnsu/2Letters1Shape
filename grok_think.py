...
arc_R = arc_points(5/12, 143.13, -143.13, center=[1/2, 3/4])
R = [(0,0), (0,1), (1/6,1)] + arc_R + [(1/6,1/2), (1,0), (0,0)]

top_arc_S = arc_points(1/4, 0, 180, center=[1/2, 3/4])
bottom_arc_S = arc_points(1/4, 180, 360, center=[1/2, 1/4])
S = top_arc_S + bottom_arc_S

T = [(0,1), (1,1), (1,5/6), (7/12,5/6), (7/12,0), (5/12,0), (5/12,5/6), (0,5/6)]

outer_arc_U = arc_points(1/2, 180, 0, center=[1/2,1/2])
inner_arc_U = arc_points(1/3, 0, 180, center=[1/2,1/2])[::-1]
U = outer_arc_U + inner_arc_U + [(1/6,1), (0,1), (0,0), (1,0), (1,1), (5/6,1)]

V = [(0,1), (1/6,1), (1/2,1/3), (5/6,1), (1,1), (1,5/6), (2/3,1/3), (1/3,1/3), (0,5/6)]

W = [(0,1), (1/6,1), (1/4,1/3), (1/2,1), (3/4,1/3), (5/6,1), (1,1), (1,5/6), (3/4,1/3), (1/2,5/6), (1/4,1/3), (0,5/6)]

X = [(0,1), (1/6,1), (1,1/6), (1,0), (5/6,0), (0,5/6), (0,1)]
X += [(0,0), (1/6,0), (1,1), (5/6,1), (0,1/6), (0,0)]

Y = [(0,1), (1/6,1), (1/2,1/2), (5/6,1), (1,1), (1,5/6), (7/12,1/2), (7/12,0), (5/12,0), (5/12,1/2), (1/6,5/6), (0,5/6)]

Z = [(0,1), (1,1), (1,5/6), (1/6,1/6), (1,1/6), (1,0), (0,0), (0,1/6), (5/6,5/6), (0,5/6)]